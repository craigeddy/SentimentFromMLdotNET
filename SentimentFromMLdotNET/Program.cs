...
namespace SentimentAnalysis
{
    class Program
    {
        ...
        public class SentimentDataWithID : SentimentData
        {
            public int ID;
        }
        public static void UseModelWithBatchItems(MLContext mlContext, ITransformer model)
        {
            ...
            IEnumerable<SentimentPrediction> sentiments = new[]
            {
                new SentimentPrediction
                {
                    SentimentText = "This was a horrible meal", ID = 1
                },
                new SentimentPrediction
                {
                    SentimentText = "I love this spaghetti.", ID = 2
                }
            };
            // </SnippetCreateTestIssues>
            ...
            {
                Console.WriteLine($"{prediction.ID} Sentiment: {prediction.SentimentText} | Prediction: {(Convert.ToBoolean(prediction.Prediction) ? "Positive" : "Negative")} | Probability: {prediction.Probability} ");
            }
            Console.WriteLine("=============== End of predictions ===============");
            // </SnippetDisplayResults>
        }
